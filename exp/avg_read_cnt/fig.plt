...
set ylabel "Lookup count per query" offset 1.5,0
...
plot "./data/avg.csv" u 2:xtic(1) ti "Hash(8)" lc rgb "#90EE90" ,\
	"" u 3 ti "LSM-KVD(5,0)" lc rgb "#D2B48C" ,\
	"" u 4 ti "LSM-KVD(5,3)" lc rgb "#8B0000" ,\
