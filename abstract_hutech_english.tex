...
Owing to its popularity and huge impact on application performance, serious efforts have been made to optimize KVS at various ways.  
...
And it also occur another types of collision ~\ie{Differents two keys can have a same signature}.
